...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2018. Feb 24. 12:37
...
CREATE TABLE `foglalkozasok` (
  ...
  `megyekod` int(11) DEFAULT NULL,
  `mezogazdasag` int(11) DEFAULT NULL,
  `ipar` int(11) DEFAULT NULL,
  `szolgaltatas` int(11) DEFAULT NULL
...
CREATE TABLE `lakosok` (
  `megyekod` int(11) NOT NULL,
  `lakosszam` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
CREATE TABLE `megyek` (
  `megyekod` int(11) NOT NULL,
  `regiokod` int(11) NOT NULL,
  `megyenev` varchar(100) COLLATE utf8_hungarian_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
CREATE TABLE `regiok` (
  `regiokod` int(11) NOT NULL,
  `regionev` varchar(100) COLLATE utf8_hungarian_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
ALTER TABLE `foglalkozasok`
  ...
  ADD KEY `fk_foglalkozasok_megyek` (`megyekod`);

--
-- A tábla indexei `lakosok`
--
ALTER TABLE `lakosok`
  ADD PRIMARY KEY (`megyekod`);
...
ALTER TABLE `megyek`
  ADD PRIMARY KEY (`megyekod`),
  ADD KEY `fk_megyek_regiok` (`regiokod`);

--
-- A tábla indexei `regiok`
--
ALTER TABLE `regiok`
  ADD PRIMARY KEY (`regiokod`);
...
--
-- Megkötések a táblához `foglalkozasok`
--
ALTER TABLE `foglalkozasok`
  ADD CONSTRAINT `fk_foglalkozasok_megyek` FOREIGN KEY (`megyekod`) REFERENCES `megyek` (`megyekod`);

--
-- Megkötések a táblához `lakosok`
--
ALTER TABLE `lakosok`
  ADD CONSTRAINT `fk_lakosok_megyek` FOREIGN KEY (`megyekod`) REFERENCES `megyek` (`megyekod`);

--
-- Megkötések a táblához `megyek`
--
ALTER TABLE `megyek`
  ADD CONSTRAINT `fk_megyek_regiok` FOREIGN KEY (`regiokod`) REFERENCES `regiok` (`regiokod`);
COMMIT;
